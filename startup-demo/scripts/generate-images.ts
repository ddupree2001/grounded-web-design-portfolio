/**
 * Script to generate AI images for Nexus AI startup site using Nano Banana
...
const IMAGES = [
  {
    ...
    prompt:
      "Abstract futuristic data visualization. Glowing neural network nodes connected by light streams, deep space indigo and purple background, floating data points, holographic dashboard elements. Ultra-wide cinematic. Dark tech aesthetic, photorealistic digital art.",
    aspectRatio: "16:9",
  },
  {
    id: "dashboard",
    ...
    prompt:
      "Modern analytics dashboard on a dark monitor screen. Real-time charts, line graphs trending upward, metric cards with glowing numbers, clean UI with indigo and purple accent colors. Professional tech product photography on a sleek desk.",
    aspectRatio: "16:9",
  },
  {
    id: "team",
...
async function main() {
  console.log("⚡ Generating AI images for Nexus AI via Nano Banana / Imagen 3...\n");
